        ...
        <div className="grid lg:grid-cols-2 sm:grid-cols-1 auto-rows-auto gap-16 place-items-center">
          <div className="card card-compact bg-base-100 w-96 hover:scale-105 transition-transform shadow-lg shadow-sky-400 h-full">
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <button className="btn btn-outline btn-white shadow-md shadow-white" onClick={()=>document.getElementById('my_modal_1').showModal()}>Show more</button>
          ...
          <div className="card card-compact bg-base-100 w-96 shadow-lg hover:scale-105 transition-transform shadow-sky-400 h-full">
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <button className="btn btn-outline btn-white shadow-md shadow-white" onClick={()=>document.getElementById('my_modal_2').showModal()}>Show more</button>
          ...
          <div className="card card-compact bg-base-100 w-96 shadow-lg hover:scale-105 transition-transform shadow-sky-400 h-full">
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <button className="btn btn-outline btn-white shadow-md shadow-white" onClick={()=>document.getElementById('my_modal_3').showModal()}>Show more</button>
          ...
          <div className="card card-compact bg-base-100 w-96 shadow-lg hover:scale-105 transition-transform shadow-sky-400 h-full">
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <button className="btn btn-outline btn-white shadow-md shadow-white" onClick={()=>document.getElementById('my_modal_4').showModal()}>Show more</button>
